...
const NavPill = ({ to, children }: { to: string; children: ReactNode }) => (
  <Link
    to={to}
    className="inline-block text-white px-4 py-2 border border-white rounded-full text-xs font-black tracking-wide transition-all duration-200 hover:bg-white hover:text-black"
  >
    {children}
  </Link>
)
  ...
  return (
    <footer className="mx-auto bg-black">
      <div className="px-12 pt-12">
        <div className="text-[#e11010] font-black leading-none tracking-tighter select-none mb-10 text-[clamp(80px,14vw,200px)] text-center">
        ...
        <div className="grid grid-cols-2 gap-20 pb-12">
          <div>
            <p className="font-black text-white uppercase leading-tight mt-5 max-w-sm text-2xl">
              CREATING MEANINGFUL BRANDS THROUGH <br />STRATEGY AND DESIGN. <span className="text-[#e11010]">ALWAYS & ALL WAYS.</span>
            </p>
          </div>
      ...
      <div className="border-t border-white px-12 py-6 flex flex-wrap justify-between items-center gap-4">
        <div>
          ...
          <p className="font-black text-[#e11010] tracking-wide">
            BOOWAVE@GMAIL.COM
          </p>
        </div>

        <p className="text-white text-center mt-2">
          © Copyright - <span className="text-[#e11010] font-bold">Boowave.</span> | Powered by{" "}
          <span className="text-[#e11010] font-bold">Webflow</span>
          {" "}| Made By{" "}
          <span className="text-[#e11010] font-bold">Wkkkuu</span>
        </p>

        <div className="flex items-center bg-[#1a1a1a] rounded-full pl-4 pr-2 py-2 gap-3">
          <div className="flex gap-2 items-center">
            <span className="w-7 h-7 rounded-full bg-gradient-to-br from-[#e11010] to-black block" />
            <span className="w-7 h-7 rounded-full bg-gradient-to-br from-[#e11010] to-black block" />
          </div>
