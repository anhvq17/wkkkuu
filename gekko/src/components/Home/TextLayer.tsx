...
const TextLayer = () => {
  ...
  const lines = [
    "Airphoria combines the signature design elements of Nike Air Max with the dynamic and ever evolving landscape of Fortnite, allowing players to engage with Gekko Air Max sneakers in new, captivating ways."
  ];
